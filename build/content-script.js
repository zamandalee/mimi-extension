...
/******/ 	return hotCreateRequire("./src/content-script.js")(__webpack_require__.s = "./src/content-script.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!********************************!*\
  !*** ./src/Utils/constants.js ***!
  \********************************/
/*! exports provided: blue, darkBlue, gold, orange, lightGray, defaultBucket, defaultWeek */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defaultBucket", function() { return defaultBucket; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defaultWeek", function() { return defaultWeek; });
const blue = "#33658a";
const darkBlue = "#2f4858";
const gold = "#f6ae2d";
const orange = "#f26419";
const lightGray = "rgb(247, 247, 247)";
const defaultBucket = {
  name: "Default Bucket",
  decay: 15,
  regen: 15,
...
/*!******************************!*\
  !*** ./src/Utils/storage.js ***!
  \******************************/
/*! exports provided: getData, getBuckets, getSites, getTimes, getOptions, save, clear */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTimes", function() { return getTimes; });
  ...
  return new Promise(resolve => {
    chrome.storage.sync.get("buckets", response => {
      if (Object.keys(response).length === 0) {
        save("buckets", {
          0: _constants__WEBPACK_IMPORTED_MODULE_0__["defaultBucket"]
        });
        resolve({
          0: _constants__WEBPACK_IMPORTED_MODULE_0__["defaultBucket"]
        });
  ...
  return new Promise(resolve => {
    chrome.storage.sync.get("times", response => {
      if (Object.keys(response).length === 0) {
        ...
        const defaultTimes = {
          thisWeek: _constants__WEBPACK_IMPORTED_MODULE_0__["defaultWeek"],
          lastWeek: _constants__WEBPACK_IMPORTED_MODULE_0__["defaultWeek"],
